...
class Atri:
	def __init__(self, state: Any):
		...
		self.anouncement = state["anouncement"]
		self.footer = state["footer"]
		self.Flex18 = state["Flex18"]
		self.footer_row_one = state["footer_row_one"]
		...
		self.footer_row_three = state["footer_row_three"]
		self.Flex24 = state["Flex24"]
		self.footer_row_two = state["footer_row_two"]
		self.fr_col_one = state["fr_col_one"]
		self.Flex27 = state["Flex27"]
		self.fr__col_two = state["fr__col_two"]
		self.Flex28 = state["Flex28"]
		self.fr_col_three = state["fr_col_three"]
		self.Flex30 = state["Flex30"]
		self.fr_col_four = state["fr_col_four"]
		self.Flex32 = state["Flex32"]
		self.fr_col_five = state["fr_col_five"]
		...
		self.announcement_content = state["announcement_content"]
	...
	@property
	def anouncement(self):
		self._getter_access_tracker["anouncement"] = {}
		return self._anouncement
	@anouncement.setter
	def anouncement(self, new_state):
		self._setter_access_tracker["anouncement"] = {}
		global default_state
		self._anouncement = Flex(new_state, default_state["anouncement"])
	...
	@property
	def footer_row_one(self):
		self._getter_access_tracker["footer_row_one"] = {}
		return self._footer_row_one
	@footer_row_one.setter
	def footer_row_one(self, new_state):
		self._setter_access_tracker["footer_row_one"] = {}
		global default_state
		self._footer_row_one = Flex(new_state, default_state["footer_row_one"])
	...
	@property
	def footer_row_three(self):
		self._getter_access_tracker["footer_row_three"] = {}
		return self._footer_row_three
	@footer_row_three.setter
	def footer_row_three(self, new_state):
		self._setter_access_tracker["footer_row_three"] = {}
		global default_state
		self._footer_row_three = Flex(new_state, default_state["footer_row_three"])
	...
	@property
	def footer_row_two(self):
		self._getter_access_tracker["footer_row_two"] = {}
		return self._footer_row_two
	@footer_row_two.setter
	def footer_row_two(self, new_state):
		self._setter_access_tracker["footer_row_two"] = {}
		global default_state
		self._footer_row_two = Flex(new_state, default_state["footer_row_two"])

	@property
	def fr_col_one(self):
		self._getter_access_tracker["fr_col_one"] = {}
		return self._fr_col_one
	@fr_col_one.setter
	def fr_col_one(self, new_state):
		self._setter_access_tracker["fr_col_one"] = {}
		global default_state
		self._fr_col_one = Flex(new_state, default_state["fr_col_one"])
	...
	@property
	def fr__col_two(self):
		self._getter_access_tracker["fr__col_two"] = {}
		return self._fr__col_two
	@fr__col_two.setter
	def fr__col_two(self, new_state):
		self._setter_access_tracker["fr__col_two"] = {}
		global default_state
		self._fr__col_two = Flex(new_state, default_state["fr__col_two"])
	...
	@property
	def fr_col_three(self):
		self._getter_access_tracker["fr_col_three"] = {}
		return self._fr_col_three
	@fr_col_three.setter
	def fr_col_three(self, new_state):
		self._setter_access_tracker["fr_col_three"] = {}
		global default_state
		self._fr_col_three = Flex(new_state, default_state["fr_col_three"])
	...
	@property
	def fr_col_four(self):
		self._getter_access_tracker["fr_col_four"] = {}
		return self._fr_col_four
	@fr_col_four.setter
	def fr_col_four(self, new_state):
		self._setter_access_tracker["fr_col_four"] = {}
		global default_state
		self._fr_col_four = Flex(new_state, default_state["fr_col_four"])
	...
	@property
	def fr_col_five(self):
		self._getter_access_tracker["fr_col_five"] = {}
		return self._fr_col_five
	@fr_col_five.setter
	def fr_col_five(self, new_state):
		self._setter_access_tracker["fr_col_five"] = {}
		global default_state
		self._fr_col_five = Flex(new_state, default_state["fr_col_five"])
	...
	@property
	def announcement_content(self):
		self._getter_access_tracker["announcement_content"] = {}
		return self._announcement_content
	@announcement_content.setter
	def announcement_content(self, new_state):
		self._setter_access_tracker["announcement_content"] = {}
		global default_state
		self._announcement_content = TextBox(new_state, default_state["announcement_content"])
	...
	def _to_json_fields(self):
		return {
			"Body": self._Body,
			"anouncement": self._anouncement,
			"footer": self._footer,
			"Flex18": self._Flex18,
			"footer_row_one": self._footer_row_one,
			"Flex11": self._Flex11,
			"Flex13": self._Flex13,
			"Flex14": self._Flex14,
			"Flex15": self._Flex15,
			...
			"Flex21": self._Flex21,
			"Flex22": self._Flex22,
			"footer_row_three": self._footer_row_three,
			"Flex24": self._Flex24,
			"footer_row_two": self._footer_row_two,
			"fr_col_one": self._fr_col_one,
			"Flex27": self._Flex27,
			"fr__col_two": self._fr__col_two,
			"Flex28": self._Flex28,
			"fr_col_three": self._fr_col_three,
			"Flex30": self._Flex30,
			"fr_col_four": self._fr_col_four,
			"Flex32": self._Flex32,
			"fr_col_five": self._fr_col_five,
			"Flex34": self._Flex34,
			...
			"Div3": self._Div3,
			"Flex45": self._Flex45,
			"announcement_content": self._announcement_content,
