...
class Atri:
	def __init__(self, state: Any):
		...
		self.section_one = state["section_one"]
		...
		self.top_menu = state["top_menu"]
		self.hero_section = state["hero_section"]
		self.open_source = state["open_source"]
		self.Flex43 = state["Flex43"]
		self.Flex45 = state["Flex45"]
		self.slogan_container = state["slogan_container"]
		self.Div3 = state["Div3"]
		self.subtitle_container = state["subtitle_container"]
		self.Flex224 = state["Flex224"]
		self.subtitle_container_mob = state["subtitle_container_mob"]
		...
		self.sign_up_status = state["sign_up_status"]
		self.section_two = state["section_two"]
		...
		self.made_with_atri = state["made_with_atri"]
		...
		self.code_two_snippet = state["code_two_snippet"]
		self.code_one_snippet = state["code_one_snippet"]
		self.slogan = state["slogan"]
		self.TextBox169 = state["TextBox169"]
		self.code_one = state["code_one"]
		self.code_two = state["code_two"]
		...
		self.sign_up_button = state["sign_up_button"]
		self.Input3 = state["Input3"]
		self.sign_up_status_text = state["sign_up_status_text"]
	...
	def section_one(self):
		self._getter_access_tracker["section_one"] = {}
		return self._section_one
	@section_one.setter
	def section_one(self, new_state):
		self._setter_access_tracker["section_one"] = {}
		global default_state
		self._section_one = Flex(new_state, default_state["section_one"])
	...
	@property
	def top_menu(self):
		self._getter_access_tracker["top_menu"] = {}
		return self._top_menu
	@top_menu.setter
	def top_menu(self, new_state):
		self._setter_access_tracker["top_menu"] = {}
		global default_state
		self._top_menu = Flex(new_state, default_state["top_menu"])
	...
	def open_source(self, new_state):
		...
		global default_state
		self._open_source = Flex(new_state, default_state["open_source"])
	...
	@property
	def slogan_container(self):
		self._getter_access_tracker["slogan_container"] = {}
		return self._slogan_container
	@slogan_container.setter
	def slogan_container(self, new_state):
		self._setter_access_tracker["slogan_container"] = {}
		global default_state
		self._slogan_container = Flex(new_state, default_state["slogan_container"])
	...
	@property
	def subtitle_container(self):
		self._getter_access_tracker["subtitle_container"] = {}
		return self._subtitle_container
	@subtitle_container.setter
	def subtitle_container(self, new_state):
		self._setter_access_tracker["subtitle_container"] = {}
		global default_state
		self._subtitle_container = Flex(new_state, default_state["subtitle_container"])
	...
	@property
	def subtitle_container_mob(self):
		self._getter_access_tracker["subtitle_container_mob"] = {}
		return self._subtitle_container_mob
	@subtitle_container_mob.setter
	def subtitle_container_mob(self, new_state):
		self._setter_access_tracker["subtitle_container_mob"] = {}
		global default_state
		self._subtitle_container_mob = Flex(new_state, default_state["subtitle_container_mob"])
	...
	def sign_up_status(self):
		self._getter_access_tracker["sign_up_status"] = {}
		return self._sign_up_status
	@sign_up_status.setter
	def sign_up_status(self, new_state):
		self._setter_access_tracker["sign_up_status"] = {}
		global default_state
		self._sign_up_status = Flex(new_state, default_state["sign_up_status"])

	@property
	def section_two(self):
		self._getter_access_tracker["section_two"] = {}
		return self._section_two
	@section_two.setter
	def section_two(self, new_state):
		self._setter_access_tracker["section_two"] = {}
		global default_state
		self._section_two = Flex(new_state, default_state["section_two"])
	...
	@property
	def made_with_atri(self):
		self._getter_access_tracker["made_with_atri"] = {}
		return self._made_with_atri
	@made_with_atri.setter
	def made_with_atri(self, new_state):
		self._setter_access_tracker["made_with_atri"] = {}
		global default_state
		self._made_with_atri = Flex(new_state, default_state["made_with_atri"])
	...
	@property
	def code_two_snippet(self):
		self._getter_access_tracker["code_two_snippet"] = {}
		return self._code_two_snippet
	@code_two_snippet.setter
	def code_two_snippet(self, new_state):
		self._setter_access_tracker["code_two_snippet"] = {}
		global default_state
		self._code_two_snippet = Image(new_state, default_state["code_two_snippet"])

	@property
	def code_one_snippet(self):
		self._getter_access_tracker["code_one_snippet"] = {}
		return self._code_one_snippet
	@code_one_snippet.setter
	def code_one_snippet(self, new_state):
		self._setter_access_tracker["code_one_snippet"] = {}
		global default_state
		self._code_one_snippet = Image(new_state, default_state["code_one_snippet"])

	@property
	def slogan(self):
		self._getter_access_tracker["slogan"] = {}
		return self._slogan
	@slogan.setter
	def slogan(self, new_state):
		self._setter_access_tracker["slogan"] = {}
		global default_state
		self._slogan = TextBox(new_state, default_state["slogan"])
	...
	@property
	def code_one(self):
		self._getter_access_tracker["code_one"] = {}
		return self._code_one
	@code_one.setter
	def code_one(self, new_state):
		self._setter_access_tracker["code_one"] = {}
		global default_state
		self._code_one = Image(new_state, default_state["code_one"])

	@property
	def code_two(self):
		self._getter_access_tracker["code_two"] = {}
		return self._code_two
	@code_two.setter
	def code_two(self, new_state):
		self._setter_access_tracker["code_two"] = {}
		global default_state
		self._code_two = Image(new_state, default_state["code_two"])

	@property
	def benefits(self):
		self._getter_access_tracker["benefits"] = {}
		return self._benefits
	@benefits.setter
	def benefits(self, new_state):
		self._setter_access_tracker["benefits"] = {}
		global default_state
		self._benefits = TextBox(new_state, default_state["benefits"])
	...
	def sign_up_button(self):
		self._getter_access_tracker["sign_up_button"] = {}
		return self._sign_up_button
	@sign_up_button.setter
	def sign_up_button(self, new_state):
		self._setter_access_tracker["sign_up_button"] = {}
		global default_state
		self._sign_up_button = Image(new_state, default_state["sign_up_button"])
	...
	@property
	def sign_up_status_text(self):
		self._getter_access_tracker["sign_up_status_text"] = {}
		return self._sign_up_status_text
	@sign_up_status_text.setter
	def sign_up_status_text(self, new_state):
		self._setter_access_tracker["sign_up_status_text"] = {}
		global default_state
		self._sign_up_status_text = TextBox(new_state, default_state["sign_up_status_text"])
	...
	def _to_json_fields(self):
		return {
			...
			"Menu1": self._Menu1,
			"Flex74": self._Flex74,
			"top_menu": self._top_menu,
			"hero_section": self._hero_section,
			"open_source": self._open_source,
			"Flex43": self._Flex43,
			"Flex45": self._Flex45,
			"slogan_container": self._slogan_container,
			"Div3": self._Div3,
			"subtitle_container": self._subtitle_container,
			"Flex224": self._Flex224,
			"subtitle_container_mob": self._subtitle_container_mob,
			...
			"Flex97": self._Flex97,
			"Flex92": self._Flex92,
			"sign_up_status": self._sign_up_status,
			"section_two": self._section_two,
			"Div6": self._Div6,
			...
			"made_with_atri": self._made_with_atri,
			...
			"code_two_snippet": self._code_two_snippet,
			"code_one_snippet": self._code_one_snippet,
			"slogan": self._slogan,
			"TextBox169": self._TextBox169,
			"code_one": self._code_one,
			"code_two": self._code_two,
			...
			"sign_up_button": self._sign_up_button,
			"Input3": self._Input3,
			"sign_up_status_text": self._sign_up_status_text,
